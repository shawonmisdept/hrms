...
<div class="p-6 w-[80%] mx-auto">
    ...
    <div class="bg-white rounded-xl shadow-lg p-8 border border-gray-100">
        ...
        {{-- Title --}}
        <h1 class="text-xl font-semibold mb-6 text-gray-700 border-b pb-2">Create Designation</h1>
        {{-- Success Message --}}
        @if (session('success'))
        ...
        @endif
        {{-- Form --}}
        <form action="{{ route('designations.store') }}" method="POST" class="grid grid-cols-1 md:grid-cols-2 gap-6">
            @csrf
