...
<div class="max-w-3xl mx-auto px-4 py-6">
    <h2 class="text-xl font-semibold mb-4 text-gray-800">Create New Line</h2>
    ...
    <form action="{{ route('lines.store') }}" method="POST" class="space-y-4">
        @csrf
        ...
        <div>
            ...
            <textarea name="description" rows="3"
                      class="w-full border rounded px-3 py-2 focus:outline-none focus:ring focus:border-green-500">{{ old('description') }}</textarea>
        </div>
